...
void dv_type_filler(const SettingConstPtr& /*setting*/, std::vector<IntegerSettingOption>& list, int& /*current*/) {
  list.clear();
...
void vsvdb_min_filler(const SettingConstPtr& /*setting*/, std::vector<IntegerSettingOption>& list, int& /*current*/) {
  list.clear();
...
void vsvdb_max_filler(const SettingConstPtr& /*setting*/, std::vector<IntegerSettingOption>& list, int& /*current*/) {
  list.clear();
...
void vs10_sdr_filler(const SettingConstPtr& /*setting*/, std::vector<IntegerSettingOption>& list, int& /*current*/)
{
  list.clear();
...
void vs10_hdr10_filler(const SettingConstPtr& /*setting*/, std::vector<IntegerSettingOption>& list, int& /*current*/)
{
  list.clear();
...
void vs10_hdr_hlg_filler(const SettingConstPtr& /*setting*/, std::vector<IntegerSettingOption>& list, int& /*current*/)
{
  list.clear();
...
void vs10_dv_filler(const SettingConstPtr& /*setting*/, std::vector<IntegerSettingOption>& list, int& /*current*/)
{
  list.clear();
...
bool CDolbyVisionAML::Setup()
{
  ...
  set_visible(CSettings::SETTING_COREELEC_AMLOGIC_DV_RPU_CONVERT, true);
