...
std::string COmniphonyHrtf::Explain(Result result)
{
  ...
  {
    case Result::Ok:
      return g_localizeStrings.Get(60670);
    case Result::NotFound:
      return g_localizeStrings.Get(60671);
    case Result::TooSmall:
      return g_localizeStrings.Get(60672);
    case Result::NotSofa:
      return g_localizeStrings.Get(60673);
    case Result::Unreadable:
      return g_localizeStrings.Get(60674);
    case Result::NoImpulseResponses:
      return g_localizeStrings.Get(60675);
    case Result::WrongConvention:
      return g_localizeStrings.Get(60676);
    case Result::CopyFailed:
      return g_localizeStrings.Get(60677);
  }
  return {};
}
