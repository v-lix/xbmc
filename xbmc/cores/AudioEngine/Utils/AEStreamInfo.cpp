                                 ...
                                 bool wantEAC3dependent)
{
  ...
  else
  {
        ...
        size >= m_fsize && m_fsize > 0)
    {
      ...
      int elements = -1;
      const int objects = Atmos_ParseEAC3Objects(data, m_fsize, elements);
      if (objects >= 0)
      {
        ...
        CLog::Log(LOGINFO,
                  "CAEStreamParser::TrySyncAC3 - E-AC3 JOC object metadata found, atmosChannels: "
                  "{}, atmosObjects: {} (after {} frame{})",
