...
namespace OVERLAY {
  ...
  public:
    ...
    void SetActiveAreaMargins(int top, int bottom, int left, int right);
  ...
  protected:
    ...
    */
    ...
    int m_activeAreaMarginTop{0};
    int m_activeAreaMarginBottom{0};
    int m_activeAreaMarginLeft{0};
    int m_activeAreaMarginRight{0};
