...
void CVideoDatabase::AddMissingColumns()
{
  ...
  //
  // Only names StreamUtils::GetCodecName() produces itself are restored. Its DTS profiles all
  // come out as "dca", so "dts_es" and its two siblings are left alone rather than written once
  // and contradicted by the next scan.
  //
  ...
  if (HasColumn("streamdetails", "strAudioProfile"))
  {
    ...
    static const ExtendedAudioCodec extendedAudioCodecs[] = {
        ...
        {"aac", "AAC-LC", "aac_lc"},               {"aac", "HE-AAC", "he_aac"},
        {"aac", "HE-AAC v2", "he_aac_v2"},         {"aac", "AAC-SSR", "aac_ssr"},
        {"aac", "AAC-LTP", "aac_ltp"}};
