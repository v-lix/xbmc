...
constexpr uint32_t SYSTEM_LINUX_VER                  = 714;
...
constexpr uint32_t PLAYER_PROCESS_AML_PIXELFORMAT    = PLAYER_PROCESS_START + 30;
constexpr uint32_t PLAYER_PROCESS_AML_DISPLAYMODE    = PLAYER_PROCESS_START + 31;
constexpr uint32_t PLAYER_PROCESS_AML_EOFT_GAMUT     = PLAYER_PROCESS_START + 32;
constexpr uint32_t PLAYER_PROCESS_AUDIOCHANNELS_SINK = PLAYER_PROCESS_START + 33;

// Per-speaker booleans (derived from channel layouts)
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_FL       = PLAYER_PROCESS_START + 34;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_FR       = PLAYER_PROCESS_START + 35;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_FC       = PLAYER_PROCESS_START + 36;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_LFE      = PLAYER_PROCESS_START + 37;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SL       = PLAYER_PROCESS_START + 38;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SR       = PLAYER_PROCESS_START + 39;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_BL       = PLAYER_PROCESS_START + 40;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_BR       = PLAYER_PROCESS_START + 41;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_TFL      = PLAYER_PROCESS_START + 42;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_TFR      = PLAYER_PROCESS_START + 43;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_TBL      = PLAYER_PROCESS_START + 44;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_TBR      = PLAYER_PROCESS_START + 45;

constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_FL  = PLAYER_PROCESS_START + 46;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_FR  = PLAYER_PROCESS_START + 47;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_FC  = PLAYER_PROCESS_START + 48;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_LFE = PLAYER_PROCESS_START + 49;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_SL  = PLAYER_PROCESS_START + 50;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_SR  = PLAYER_PROCESS_START + 51;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_BL  = PLAYER_PROCESS_START + 52;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_BR  = PLAYER_PROCESS_START + 53;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_TFL = PLAYER_PROCESS_START + 54;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_TFR = PLAYER_PROCESS_START + 55;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_TBL = PLAYER_PROCESS_START + 56;
constexpr uint32_t PLAYER_PROCESS_AUDIO_SPK_SINK_TBR = PLAYER_PROCESS_START + 57;
